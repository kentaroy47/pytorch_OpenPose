...
IMAGE_DIR_TRAIN = os.path.join(DATA_DIR, 'train2014')
IMAGE_DIR_VAL = os.path.join(DATA_DIR, 'val2014')
...
def train_cli(parser):
    ...
    group.add_argument('--batch-size', default=16, type=int,
                       help='batch size')
    group.add_argument('--lr', '--learning-rate', default=1e-2, type=float,
...
model_save_filename = './network/weights/best_pose.pth'
